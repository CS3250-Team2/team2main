...
public class CustomerOrderGUI {
	...
	private void initialize() {
		...
		addBtn.addActionListener(new ActionListener() { // connecting method to mysql database with GU to show inventory
			...
			orderHx.setBounds(6, 323, 130, 28);
			...
			btnSearchByOrder.setBounds(6, 362, 130, 29);
			...
			btnBack.setBounds(6, 442, 130, 26);
			frmClass.getContentPane().add(btnBack);
			
			JButton btnLoadCVS = new JButton("Load CVS ");
			btnLoadCVS.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			btnLoadCVS.setBounds(6, 402, 130, 29);
			frmClass.getContentPane().add(btnLoadCVS);
			...
			btnClear.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					custLocationtextField.setText("");
					ProductIDtextField.setText("");
					OrderIdtextField.setText("");
				}
			});
			
			btnClear.setBounds(6, 475, 130, 26);
			frmClass.getContentPane().add(btnClear);
